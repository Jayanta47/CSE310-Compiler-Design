...
static const flex_int16_t yy_base[17] =
    {   0,
        0,    2,   18,   19,    4,    6,    0,    0,    0,    0,
        0,    0,   19,   11,   13,   14
    } ;

static const flex_int16_t yy_def[17] =
    {   0,
       14,   14,   13,   13,   13,   13,   15,    5,    5,    6,
       16,   15,    0,   13,   13,   13
    } ;

static const flex_int16_t yy_nxt[25] =
    {   0,
       13,   13,    5,    6,    5,    6,    7,    8,    9,   10,
       11,    4,    4,    4,   12,   12,   11,   13,    3,   13,
       13,   13,   13,   13
    } ;
...
YY_RULE_SETUP
#line 24 "error.l"
{printf("too many decimal point, %s\n", yytext);}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 26 "error.l"
{printf("variable naming error, %s\n", yytext);}
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 28 "error.l"
