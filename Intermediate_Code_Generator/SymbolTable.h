...
public:
    ...
    void setSymbol(std::string symbol) {this->symbol = symbol;}
...
public:
    ...
    std::string getScopeId() {return this->idString;}
...
public:
    ...
    std::string getCurrentScopeID() {return this->currScopeTable->getScopeId();}
